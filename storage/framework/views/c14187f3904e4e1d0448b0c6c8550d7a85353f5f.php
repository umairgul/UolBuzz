    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="app-navbar-collapse">
            ...
            <ul class="nav navbar-nav">
                &nbsp;<li><a href="<?php echo e(route('faculty.index')); ?>" id="facul"><i class="fa fa-users"></i> Faculty</a></li>
                <li><a href="<?php echo e(route('departments.index')); ?>" id="dpts"><i class="fa fa-university"></i> Departments</a></li>
